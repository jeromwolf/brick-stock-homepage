        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              OntoTrade의 솔루션에 대해 궁금하신 점이 있으시면<br />
              언제든지 문의해 주세요
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 font-semibold text-lg"
                >
                  문의 접수하기
                </button>
              </form>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">contact@ontotrade.ai</p>
                      <p className="text-gray-700">support@ontotrade.ai</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">대표전화: 02-1234-5678</p>
                      <p className="text-gray-700">기술지원: 02-1234-5679</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg mb-1">업무시간</h3>
                      <p className="text-gray-700">
                        평일: 09:00 - 18:00<br />
                        주말 및 공휴일 휴무
                      </p>
